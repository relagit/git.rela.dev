...
export default () => {
    ...
    return (
        <Html lang="en">
            <ErrorBoundary
                fallback={(e, reset) => {
                    // there are issues with my dev copy of solid-start that cause <Head> to have Hydration issues, it does not impact the final page as far as i can tell
                    if (e.toString().includes("Hydration")) reset();

                    return <FourOhFour error={e} code={500} />;
                }}
            >
                <Head>

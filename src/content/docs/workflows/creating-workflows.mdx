...
Workflows can be written in TypeScript or JavaScript. They are stored in the `~/.relagit/workflows` directory.
...
mkdir src
touch src/index.ts src/native.ts vite.config.ts
```
...
At last, open up RelaGit and check to see your workflow in <span class="navigation">Settings > Workflows</span>. If it's there, you're good to go!

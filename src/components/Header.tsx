        ...
        <Transition
            onEnter={(el, done) => {
                ...
                el.animate([{ top: "-60px" }, { top: window.innerWidth < 600 ? "0px" : "20px" }], {
                    duration: 600,
                    easing: reducedMotion || window.innerWidth < 600 ? "ease" : "cubic-bezier(0.25, 1.7, 0.8, 0.8)",
                }).finished.then(() => {
                    done();
                });
            }}
            onExit={(el, done) => {
                ...
                el.animate([{ top: window.innerWidth < 600 ? "0px" : "20px" }, { top: "-60px" }], {
                    duration: 200,
                    easing: reducedMotion || window.innerWidth < 600 ? "ease" : "ease-in",
                }).finished.then(() => {
                    done();
                });
            }}
        >
            <Show when={(props.top?.() || 0) > 150 + (props.innerWidth?.() || 0) / 4}>
                <header class="header">
                    <div class="header__group">
                        <a aria-label="Home" href="/" class="header__group__link">
                            <svg width="24" height="24" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
